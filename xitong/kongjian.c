...
void on_clicked1(GtkWidget *button,GtkWidget *entry1){
    const char *kk = gtk_entry_get_text(GTK_ENTRY(entry1));  
    char *name=(char*)kk;
...
void search_info(void){
    ...
    GtkWidget *button4;
//设置按钮标签
    button1=gtk_button_new_with_label("姓名查找");
